...
export const RESULTS: SlottedCopy = {
    ...
    subsections: [
        ...
        },
        {
            ...
            paragraphs: [
                "The Strategy Space figure below plots two of the five fingerprint dimensions at a time. In [Behavior](#strategy-space:behavior), forgiveness and cooperation are plotted. In [Punishment](#strategy-space:punishment), forgiveness and retaliation are plotted. To play around with the data, see the [Custom axes](#strategy-space:custom) below.",
                "## [Behavior](#:behavior)",
                ...
                "Considering the Leaderboard's rankings and the two Strategy Space plots together, the pattern becomes clear: personas (prompting) affect behavior far more than model differences do. Exploration of this finding continues with the [Persona Slope figure](#persona-slope) in the Discussion section.",
            ],
            slotAfterParagraph: 0,
        },
        {
