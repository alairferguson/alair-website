...
export const METHODOLOGY: SlottedCopy = {
    ...
    subsections: [
        ...
        },
        {
            ...
            paragraphs: [
                "The five models used in this tournament are Claude Haiku 4.5, GPT-4o-mini, Gemini 3.1 Flash Lite, Grok 4.1 Fast (non-reasoning), and Qwen 2.5 7B. Each was presented the game through four system-prompt personas (Selfish, Cooperative, Payoff-only, and Neutral) which are shown in the [Appendix](#appendix), as well as the per-turn user prompts. Crossing five models with four personas produced the 20 LLM × persona players in the tournament. See all 27 players below:",
            ],
            slotAfterParagraph: 0,
        },
        {
