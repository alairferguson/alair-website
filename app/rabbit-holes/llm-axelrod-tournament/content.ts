...
export const METHODOLOGY: SlottedCopy = {
    ...
    subsections: [
        ...
        },
        {
            ...
            paragraphs: [
                "In Axelrod’s original and subsequent tournaments, players submitted their chosen strategies ahead of time and the tournament ran on these deterninistic instructions. Of those that have proven the strongest over time, seven classic strategies were selected as players for this simulation:",
            ],
            list: [
        ...
        },
        {
            ...
            paragraphs: [
                ...
                "To find an LLM × persona player's nearest classic strategy, I take the [Euclidean distance](https://hlab.stanford.edu/brian/euclidean_distance_in.html) between its fingerprint and every classic strategy's fingerprint in that same five-dimensional space, and report the closest match.",
                "A short distance means an LLM's aggregate behavior (how often it cooperates, how it opens, how sharply it punishes and how readily it forgives) statistically resembles a classic strategy's. It does not mean the LLM is internally running that strategy's exact rule; see [Limitations](#limitations) for more on this distinction.",
            ],
            slotAfterParagraph: 0,
        },
    ],
...
export const LIMITATIONS: ProseCopy = {
    ...
    list: [
        ...
        "**A fixed payoff matrix.** Dynamically changing the payoff values (e.g., sliding the temptation and sucker values across the boundary into Stag Hunt, Chicken, and Harmony) would show whether persona still outweighs model identity once the incentive structure itself changes. This natural, if larger, sequel is a possible extension for this project.",
