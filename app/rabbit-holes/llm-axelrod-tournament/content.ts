...
export const LIMITATIONS: ProseCopy = {
    ...
    list: [
        ...
        "**Leakage into unrelated tasks** — whether a persona's disposition here bleeds into coding, summarizing, or negotiating — is a real question and a separate project.",
        "**No probing strategy.** Nothing in this field defects once and returns to cooperation, so no player's forgiveness, model or classic, is ever tested by a live opponent. Therefore, any single forgiveness number should be treated as provisional.",
        "**A fixed payoff matrix.** Sliding the temptation and sucker values across the boundary into Stag Hunt, Chicken, and Harmony would show whether persona still outweighs model identity once the incentive structure itself changes. This natural, if larger, sequel is a possible extension for this project.",
